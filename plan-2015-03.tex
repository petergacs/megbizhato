...
\item \( x \) is \df{neutral} if the head is on its left,
\( L(y)=\lambda \) over \( \lint{x}{x+\B} \), 
it is \( \le\lambda-1 \) over \( \lint{x+\B}{x+2\B} \), % {how about a small dirt?}
and \( \cCanTurn(x)=\true \).

\item \( x \) is in a \df{half turn} if the head is on the right of \( x+\B \),
 \( L(y)=\lambda \) over \( \lint{x}{x+\B} \),
\( L(y)=\lambda-\mHalfTurn \) over \( \lint{x+\B}{x+2\B} \),
and \( \cCanTurn(x)=\false \).

\item \( x \) is in a \df{completed turn} if the head is on its left,
\( L(y)=\lambda \) over \( \lint{x}{x+\B} \),
\( L(y)=\lambda-\mTurnDone \) over \( \lint{x+\B}{x+2\B} \),
and \( \cCanTurn(x)=\false \).

\item \( x \) is \df{a rebuilding boundary} if the head is on the right of \( x+\B \),
 and \( L(y)=\lambda-\mRebuild \) over \( \lint{x-2\B}{x+2\B} \). % Possibly more?
