...
We will apply Lemma~\ref{lem:dam-free-esc} together with
the basic trajectory properties to prove a lemma that can be used to
track the elimination of damage.
...
the total volume of hole sizes in a cheese is at most twice the size of its bulk.
