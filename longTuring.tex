...
It is a \df{colony} if the addresses grow from \( 0 \) to \( Q-1 \).
It is a \df{bridge} if it consists of bridge cells, a \df{target} if it consists of target cells.
...
\item[Segments]
  ...
  \begin{bullets}
  \item A segment of the \df{base colony} consisting of member cells.
...
It is convenient to 
introduce also a \df{virtual address} \( \cAddr' \) for a bridge cell,
